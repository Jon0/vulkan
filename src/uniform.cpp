...
void Uniform::updateUniformBuffer(const VkExtent2D &swapChainExtent) {
    ...
    for (size_t i = 0; i < descriptorCount; ++i) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), offset * glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        ubo.view = glm::lookAt(glm::vec3(20.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
