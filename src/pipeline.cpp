...
VkInstance &Pipeline::getInstance() {
    return instance;
}
...
void Pipeline::createRenderPass(VkDevice &device, const VkFormat &swapChainImageFormat) {
...
void Pipeline::setup(VkDevice &device, const VkExtent2D &swapChainExtent) {
